...
from typing import overload, Tuple, Callable, List, Optional, Union, ContextManager
...
class oal:
    ...
    class ALBuffer:
        def id(self) -> int: ...
        def data(self) -> oal.WaveData: ...

    class ALSource:
        def id(self) -> int: ...

        def play(self, buffer: oal.ALBuffer) -> None: ...
        def pause(self) -> None: ...
        ...
        def set_offset(self, sec: float) -> None: ...
    ...
    class ALStream:
        ...
        def __init__(self, ctx: oal.Context): ...
    ...
    class Context(ContextManager[oal.Context]):
        def __init__(self) -> None: ...

        def __enter__(self) -> oal.Context: ...
        def __exit__(self, exc_type, exc_value, traceback) -> None: ...

        def get_device_name(self) -> str: ...
        def source(self) -> oal.ALSource: ...
        def buffer(self, path: str) -> oal.ALBuffer: ...
        def stream(self) -> oal.ALStream: ...

        @staticmethod
        def decode(path: str) -> oal.WaveData: ...